                        ...
                        <div data-testid="news-details">
                            ...
                            <div class="tax-meta govuk-!-margin-top-5">
                                ...
                                if ($categories && $categories[0]->name !== 'Uncategorized') : ?>
                                    <span class="govuk-body-s tag_label govuk-!-margin-bottom-0" data-testid="news-category">
                                ...
                                if ($terms && !is_wp_error($terms)) : $term = array_shift($terms); ?>
                                    <span class="govuk-body-s tag_label grey govuk-!-margin-bottom-0" data-testid="news-tax">
