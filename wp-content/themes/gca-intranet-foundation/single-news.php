                ...
                <div class="govuk-grid-row">
                    ...
                    <div class="govuk-grid-column-two-thirds ">
                        ...
                        <div data-testid="news-details">
                            ...
                            <div class="tax-meta govuk-!-margin-top-5">
                                <?php
                                $categories = get_the_category();
                                $terms = get_the_terms(get_the_ID(), 'label');

                                if ($categories && $categories[0]->name !== 'Uncategorized') : ?>
                                    <span class="govuk-body tag_label govuk-!-margin-bottom-0" data-testid="news-category" style="font-size:16px;">
                                ...
                                if ($terms && !is_wp_error($terms)) : $term = array_shift($terms); ?>
                                    <span class="govuk-body tag_label grey govuk-!-margin-bottom-0" data-testid="news-tax" style="font-size:16px;">
