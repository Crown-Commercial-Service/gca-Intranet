...
<div class="gca-profile-tabs govuk-!-margin-top-6" id="gca-profile-tabs">
  ...
  <nav class="gca-profile-tabs__nav" role="tablist" aria-label="Your activity">
    <button
      ...
      data-tab="saves"
    >
      <svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden="true" focusable="false"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" stroke="currentColor" stroke-width="1.8" stroke-linejoin="round"/></svg>
      My Saves
    </button>
        ...
        listEl.innerHTML = items.map(function (item) {
            ...
            return '<li class="gca-profile-item">' +
                ...
                '<button class="gca-profile-item__star gca-profile-item__star--saved" ' +
                    ...
                    '<svg width="20" height="20" viewBox="0 0 24 24" aria-hidden="true" focusable="false"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" fill="currentColor" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/></svg>' +
                '</button>' +
            '</li>';
        }).join('');
