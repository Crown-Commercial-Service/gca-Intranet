...
class GCA_Workflow_Roles {
    ...
    // WordPress maps the page post type's create_posts to edit_pages, so the
    // "Add Page" submenu and button show for anyone with edit_pages. Remove them
    // explicitly for contributors via menu and CSS.
