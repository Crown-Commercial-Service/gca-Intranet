jQuery(document).ready(function () {
	...
	clickfn2 = function () {
		var ischecked = jQuery('#input_ga_disablewplogin').is(':checked');
		if (!ischecked) {
			jQuery('#input_ga_hidewplogin').prop('checked', false);
		}
		...
		jQuery('#input_ga_disableGlogin').prop(
			'disabled',
			jQuery('#input_ga_disablewplogin').is(':checked'),
		);
	};
	...
	clickfn3 = function () {
		jQuery('#input_ga_disablewplogin').prop(
			'disabled',
			jQuery('#input_ga_disableGlogin').is(':checked'),
		);
	};
	...
	jQuery('#input_ga_disableGlogin').on('click', clickfn3);
	clickfn3();
	...
	if (jQuery('#input_ga_disablewplogin:checkbox:checked').length > 0) {
		jQuery('#input_ga_disableGlogin').prop('checked', false);
		jQuery('#input_ga_disableGlogin').prop('disabled', true);
	} else {
		jQuery('#input_ga_disableGlogin').prop('disabled', false);
	}
	if (jQuery('#input_ga_disableGlogin:checkbox:checked').length > 0) {
		jQuery('#input_ga_disablewplogin').prop('checked', false);
		jQuery('#input_ga_disablewplogin').prop('disabled', true);
	} else {
		jQuery('#input_ga_disablewplogin').prop('disabled', false);
	}
});
